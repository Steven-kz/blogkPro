import{_ as i,r as n,o as t,c as d,b as l,a as s}from"./app-34d4b3ab.js";const a={},r=s(`<h1 id="mysql基础" tabindex="-1"><a class="header-anchor" href="#mysql基础" aria-hidden="true">#</a> Mysql基础</h1><h3 id="一、什么是sql" tabindex="-1"><a class="header-anchor" href="#一、什么是sql" aria-hidden="true">#</a> 一、什么是SQL</h3><blockquote><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>1.什么是SQL？
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></blockquote><h5 id="_2-2-右外连接" tabindex="-1"><a class="header-anchor" href="#_2-2-右外连接" aria-hidden="true">#</a> 2.2 右外连接：</h5><blockquote><p>语法：</p><p>​ select 字段列表 from 表1 right [outer] join 表2 on 条件； ​ 查询的是右表所有数据以及其交集部分。</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>例子：
