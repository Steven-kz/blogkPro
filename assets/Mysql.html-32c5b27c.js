import{_ as t,r as s,o as r,c as d,d as n,e as c,b as e,a}from"./app-34d4b3ab.js";const p={},o=a(`<h1 id="一、mysql进阶" tabindex="-1"><a class="header-anchor" href="#一、mysql进阶" aria-hidden="true">#</a> 一、Mysql进阶</h1><h3 id="_1-1mysql基础" tabindex="-1"><a class="header-anchor" href="#_1-1mysql基础" aria-hidden="true">#</a> 1.1Mysql基础</h3><p>DBMS：数据库管理系统<br> Mysql数据库的数据类型<br> 1.数字类型：int bigint tinyint double decimal(⻓度，⼩数点的位数)<br> 2.字符串类型：char varchar text<br> 3.⽇期类型：date datetime<br> Mysql约束条件：为字段添加约束条件<br> 1.主键约束<br> 2.外键约束<br> 3.⾮空约束<br> 4.唯⼀约束<br> 5.⾃增约束<br> 6.默认约束<br> SQL：结构化查询语⾔，操作数据库<br> SQL分类：<br> 1.DDL:数据定义 create drop alter<br> 2.DML:数据操作 insert update delete<br> 3.DQL:数据查询 select<br> 4.TPL(TCL):事务处理 commit rollback<br> 5.DCL:数据控制语⾔ grant<br> 6.CCL:指针控制语⾔ cursor</p><h4 id="_7大语句" tabindex="-1"><a class="header-anchor" href="#_7大语句" aria-hidden="true">#</a> 7⼤语句：</h4><p>1.创建表：CREATE table 表名 (字段 数据类型 约束条件,……)<br> 2.修改表：ALTER TABLE 表名 ADD 字段名 数据类型 约束条件<br> 3.删除表：DROP TABLE 表名<br> 4.新增数据：INSERT INTO 表名(字段名,……) values(值,……)<br> 5.修改数据：UPDATE 表名 set 字段=值,…… [where 条件]<br> 6.删除数据：DELETE FROM 表名 [where 条件]<br> 7.查询数据：SELECT 字段|* FROM 表名 [where 条件]<br> 查询条件：and or in like between and not is null order by limit group by having<br> 聚合函数：avg max min count sum<br> 复杂查询：⼦查询、笛卡尔积查询（⾃然查询）、内连接、左外连接、右外连接、全连接（Mysql不⽀ 持）<br> 需要刷题：https://www.nowcoder.com/exam/oj?page=1&amp;tab=SQL%E7%AF%87&amp;topicId=268<br> 数据删除：drop（把表都删除）、delete（删除表中数据）、truncate（删除表中的数据，并删除⾃增 器）<br> 单位：分 bigint 好处：避免四舍五⼊ 缺陷：⻚⾯需要处理<br> 单位：元 decimal 好处：单位元，不需要额外处理 缺陷：四舍五⼊</p><h3 id="_1-2-视图" tabindex="-1"><a class="header-anchor" href="#_1-2-视图" aria-hidden="true">#</a> 1.2 视图</h3><p>视图：对查询语句（临时表）的封装，简化操作，操作视图跟操作表⼀样<br> 创建视图：</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>create view 视图名 as 查询语句; 
...
-- 使用函数  
select fun_test(20)      
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311002655.png" alt="image.png"></p><h3 id="_1-5自定义函数" tabindex="-1"><a class="header-anchor" href="#_1-5自定义函数" aria-hidden="true">#</a> 1.5自定义函数</h3><p>必须有返回值<br> 创建函数： function</p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>delimiter $  
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>索引的分类：<br><strong>1.主键索引</strong><br><strong>2.普通索引</strong><br><strong>3.唯⼀索引</strong><strong>4.联合索引（复合索引）</strong><br><strong>没有索引之前：</strong><br><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311002735.png" alt="image.png"><strong>创建索引之后：</strong><br><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311002943.png" alt="image.png"> 由于数据不多，所以性能提升并不明显<br><strong>查看是否存在索引：</strong><br><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311003034.png" alt="1"> explain的结果说明：<br> type所显示的是查询使⽤了哪种类型，type包含的类型包括如下图所示的⼏种，从好到差依次是<br><strong>system &gt; const &gt; eq_ref &gt; ref &gt; range &gt; index &gt; all</strong><br><strong>查看表上的索引：</strong></p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>show index from t_pcall
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311003101.png" alt="image.png"><strong>联合索引，最左侧原则：</strong><br><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311003201.png" alt="image.png"><strong>只有最左侧被当为索引</strong><br> 那么为什么还要创建联合索引呢？？<br><strong>减少开销。建一个联合索引(col1,col2,col3)，实际相当于建了(col1),(col1,col2),(col1,col2,col3)三个索引。每多一个索引，都会增加写操作的开销和磁盘空间的开销。对于大量数据的表，使用联合索引会大大的减少开销！</strong></p><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>
-- 索引：提升查询效率  
-- 1.将原有表中的数据再次添加   
...
11.limit 
分⻚ 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,47),u=n("br",null,null,-1),v=n("strong",null,"笛卡尔积乘积指在数学上，两个",-1),m={href:"https://so.csdn.net/so/search?q=%E9%9B%86%E5%90%88&spm=1001.2101.3001.7020",target:"_blank",rel:"noopener noreferrer"},b=n("strong",null,"集合",-1),k=n("strong",null,"X和Y的笛卡尔积 (Cartesian product)，又称直积，表示 X x Y，第一个对象是 X 的成员而第二个对象是 Y 的所有可能有序对的其中一个成员。",-1),g=a(`<div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>eg1:
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="三、mysql集群" tabindex="-1"><a class="header-anchor" href="#三、mysql集群" aria-hidden="true">#</a> 三、Mysql集群</h2><p>在⾼并发下、海量数据下，在所难免就要实现Mysql的集群搭建<br> Mysql本身可以实现主从复制，我们需要完成配置，就可以实现数据从主库⾃动到从库。</p><h3 id="_1-sharding-jdbc实现mysql集群" tabindex="-1"><a class="header-anchor" href="#_1-sharding-jdbc实现mysql集群" aria-hidden="true">#</a> 1. Sharding-JDBC实现Mysql集群</h3><p>Sharding-JDBC 是<strong>当当⽹</strong>开源的适⽤于微服务的分布式数据访问基础类库，完整的实现了分库分表，读<br> 写分离和分布式主键功能，并初步实现了柔性事务。从 2016 年开源⾄今，在经历了整体架构的数次精<br> 炼以及稳定性打磨后，如今它已积累了⾜够的底蕴。<br> ShardingSphere是⼀套开源的分布式数据库中间件解决⽅案组成的⽣态圈，它由Sharding-JDBC、<br> Sharding-Proxy 和 Sharding-Sidecar这3款相互独⽴的产品组成。<br> https://shardingsphere.apache.org/document/current/cn/quick-start/shardingsphere-jdbc-quick start/ 1.maven配置</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code>        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.staticaly.com/gh/Steven-kz/BlogImgs@master/imgaes/20230311104645.png" alt="image.png"> 这⾥遇到⼀个bug: Sharding-jdbc使⽤Drud不能依赖druid-spring-boot-starter<br> 只能依赖:druid,否则就会遇到⼀个坑，报 Property &#39;sqlSessionFactory&#39; or &#39;sqlSessionTemplate&#39;<br> are requi<br> 后来查阅⽂档，官⽅⽂档，发现原来Sharding-jdbc4.0之后。就不能依赖这个包，会引起冲突。因为我<br> 们使⽤的Sharding-jdbc5.0以后的版本</p>`,20);function y(h,q){const i=s("ExternalLinkIcon"),l=s("PDF");return r(),d("div",null,[o,n("p",null,[c("笛卡尔积是什么？"),u,v,n("a",m,[b,e(i)]),k]),g,e(l)])}const f=t(p,[["render",y],["__file","Mysql.html.vue"]]);export{f as default};
